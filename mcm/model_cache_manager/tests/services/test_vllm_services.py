...
def create_mock_kernel(hash_val: str = "test_hash", name: str = "test_kernel") -> Kernel:
...
class TestIndexServiceVllmMode(unittest.TestCase):
    ...
    @patch('model_cache_manager.services.index.VllmCacheRepository')
    @patch('model_cache_manager.services.index.VllmDatabase')
    ...
    @patch('model_cache_manager.services.index.CacheRepository')
    @patch('model_cache_manager.services.index.Database')
    ...
    def test_reindex_vllm_mode(self, mock_vllm_db, mock_vllm_repo):
        ...
        mock_db_instance.insert_kernel.assert_any_call(mock_kernel2, "/cache/root", "vllm_hash2")
    ...
    def test_reindex_triton_mode(self, mock_db, mock_repo):
        ...
        mock_db_instance.insert_kernel.assert_any_call(mock_kernel2, str(self.cache_dir))
...
class TestPruningServiceVllmMode(unittest.TestCase):
    ...
    @patch('model_cache_manager.services.prune.VllmCacheRepository')
    ...
    @patch('model_cache_manager.services.prune.CacheRepository')
    @patch('model_cache_manager.services.prune.Database')
    def test_init_triton_mode(self, mock_db, mock_repo):
